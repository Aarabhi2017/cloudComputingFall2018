...
public class StudentResource {
	...
	// {
	// List<String> gogo = new ArrayList<String>();
	// gogo.add("Hello");
	// gogo.add("from the otherside");
	//
	// final ByteArrayOutputStream out = new ByteArrayOutputStream();
	// final ObjectMapper mapper = new ObjectMapper();
	//
	// try {
	// mapper.writeValue(out, gogo);
	// } catch (Exception e) {
	// // TODO Auto-generated catch block
	// e.printStackTrace();
	// }
	...
	public boolean addCourse(@PathParam("studentId") String studentId, @FormParam("courseId") String courseId) {
	...
	public Student addStudent(@FormParam("studentId") String studentId, @FormParam("firstName") String firstName,
		...
		return studentService.addStudent(studentId, firstName, lastName, dept);
	}
